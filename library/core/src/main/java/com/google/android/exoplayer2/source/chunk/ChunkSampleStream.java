...
public class ChunkSampleStream<T extends ChunkSource> implements SampleStream, SequenceableLoader,
  ...
  public static ChunkSampleStreamFactory DEFAULT_FACTORY =
          (primaryTrackType, embeddedTrackTypes, embeddedTrackFormats, chunkSource, callback, allocator, positionUs, drmSessionManager, drmEventDispatcher, loadErrorHandlingPolicy, mediaSourceEventDispatcher) ->
                  new ChunkSampleStream(primaryTrackType, embeddedTrackTypes, embeddedTrackFormats, chunkSource, callback, allocator, positionUs, drmSessionManager, drmEventDispatcher, loadErrorHandlingPolicy, mediaSourceEventDispatcher);
  ...
  protected @MonotonicNonNull Format primaryDownstreamTrackFormat;
