...
public abstract class MediaCodecRenderer extends BaseRenderer {
  ...
  @Nullable protected DrmSession codecDrmSession;
   ...
   */
  protected void queueSecureInputBuffer(int index, int offset, CryptoInfo info, long presentationTimeUs, int flags) throws MediaCodec.CryptoException {
    codecAdapter.queueSecureInputBuffer(index, offset, info, presentationTimeUs, flags);
  }
  ...
  protected int getInputIndex() {
    int index = codecAdapter.dequeueInputBufferIndex();
    return index;
  }

  protected void clearInput(boolean flushCodec){
    if(flushCodec && codecAdapter != null) {
      codecAdapter.flush();
    }
  }
