...
public class CanvasSubtitleOutput extends View implements SubtitleView.Output {
  ...
  @Cue.TextSizeType protected int textSizeType;
  protected float textSize;
  protected CaptionStyleCompat style;
  protected float bottomPaddingFraction;
  ...
  public void update(
    ...
    while (painters.size() < cues.size()) {
      painters.add(createSubtitlePainter(getContext()));
    }
  ...
  protected void drawWithPainter(
