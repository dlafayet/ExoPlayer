...
public class SubtitleView extends FrameLayout implements TextOutput {
  ...
  public SubtitleView(Context context, @Nullable AttributeSet attrs) {
    ...
    CanvasSubtitleOutput canvasSubtitleOutput = createCanvasSubtitleOutput(context, attrs);
  ...
  // NFLX - we want to customize the display of subtitles, so allow creating a custom Output
  protected CanvasSubtitleOutput createCanvasSubtitleOutput(Context context, @Nullable AttributeSet attrs) {
    return new CanvasSubtitleOutput(context, attrs);
  }
}
