...
public class FragmentedMp4Extractor implements Extractor {
  ...
  private void onLeafAtomRead(LeafAtom leaf, long inputPosition) throws ParserException {
    if (!containerAtoms.isEmpty()) {
      ...
      Track track = tb != null? tb.moovSampleTable.track : null;
  ...
  private boolean readSample(ExtractorInput input) throws IOException {
    ...
    if (trackBundle.fragment.sampleIsDisposable[currentTrackBundle.currentSampleIndex]) {
  ...
  private static final class TrackBundle {
    ...
    public void reset(TrackSampleTable moovSampleTable, DefaultSampleValues defaultSampleValues) {
      ...
      resetFragmentInfo();
      fragment.mediaTimeOffset = moovSampleTable.track.getMediaTimeOffset() != -1 ? moovSampleTable.track.getMediaTimeOffset() : 0;
    }
